...
describe('TestingPage', () => {
  it('runs the service amount consistency test and shows inconsistent services with lines', async () => {
    setup()
    ...
    expect(screen.getByText('Alpha GmbH / Hosting')).toBeInTheDocument()
    ...
    expect(screen.getByText(/Ausgänge: 2/)).toBeInTheDocument()

    const details = screen.getByText(/Buchungszeilen anzeigen \(2\)/i).closest('details')
